<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($table == FALSE)
        {
            ...
            $query = "INSERT INTO `inventory` (`Kode`, `Quantity`) values ('$kode', '$qty')";
            $result = mysqli_query($conn1, $query);
            $query = "INSERT INTO `history` (`Date`, `Kode`, `Quantity`, `Status`) values (CURRENT_DATE, '$kode', '$qty', 'Masuk Baru')";
            $result = mysqli_query($conn1, $query);
            header("location:inbaru.php?success=1");
        }
        else
        {
            header("location:inbaru.php?error=1");
        }
    }
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <h1 class="page-header">Masuk Barang Baru
        ...
        <form action="inbaru.php" method="post">
        <div class="form-group">
          ...
          <?php
            ...
            {
                echo '<font color="#FF0000"><p align="center">Record failed! Ini barang repeat</p></font>';
            }
